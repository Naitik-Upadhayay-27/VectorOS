      ...
      <div className="relative z-10 flex flex-col items-center gap-6 max-w-sm">
        ...
        <div className="space-y-3">
          ...
          <h1 className="text-white text-2xl font-extrabold leading-tight">
            This pup needs a bigger screen 🐾
          </h1>
        ...
        <div className="space-y-3 w-full">
          ...
          <div className="flex items-center justify-center gap-2.5 px-5 py-3.5 rounded-2xl bg-black border border-purple-500/40 shadow-[0_0_20px_rgba(168,85,247,0.15)] hover:border-purple-500/70 hover:shadow-[0_0_28px_rgba(168,85,247,0.3)] transition-all cursor-default">
        ...
        <p className="text-white/20 text-[11px] tracking-wide">
          Skill Vector · Mobile dropping soon ✦
        </p>
      </div>
    </div>
  )
