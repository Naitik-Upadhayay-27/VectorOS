...
const testimonials: Testimonial[] = [
  { name: 'Priya Sharma',   role: 'Software Engineer',  company: 'Google',   quote: 'Skill Vector rewrote my resume bullets in minutes. I went from zero callbacks to 4 interviews in a week. The ATS scorer told me exactly what was missing.',                                                    image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=PriyaSharma&backgroundColor=b6e3f4'    },
  ...
  { name: 'Sofia Reyes',    role: 'UX Designer',        company: 'Figma',    quote: 'I landed my dream job at Figma after using Skill Vector for 2 weeks. The keyword gap analysis helped me tailor my resume to the exact job description.',                                                        image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SofiaReyes&backgroundColor=ffeaa7'     },
  ...
  { name: 'Mei Lin',        role: 'ML Engineer',        company: 'OpenAI',   quote: 'Skill Vector identified that I was underselling my impact. After the AI rewrites, my experience section finally matched the seniority I was applying for.',                                                     image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=MeiLin&backgroundColor=ffeaa7'         },
];
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-white/40 text-base max-w-xl">
            See how job seekers are landing interviews faster with Skill Vector — real stories, real impact.
          </p>
        </motion.div>
